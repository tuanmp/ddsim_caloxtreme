...
particle_direction = np.array([0.97345626, 0.22640614, 0.03351366])
...
def cylindrical_wall(r, theta, z_arr, RT=None, layer_id=0):
...
def annular_cap(z, r_arr, theta, RT=None, layer_id=0):
...
def radial_wall(th, r_arr, z_arr, RT=None, layer_id=0):
...
def assemble_traces(
    ...
    surfaces = [
        ...
        radial_wall(
            theta_min, r_arr, z_arr, RT, layer_id
        ),  # closing side wall at theta_min
        radial_wall(
            theta_max, r_arr, z_arr, RT, layer_id
        ),  # closing side wall at theta_max
    ]
...
def main():
    ...
    layout = go.Layout(
        ...
        scene=dict(
            ...
            aspectmode="cube",
            xaxis=dict(
                title="x", color="#5b7fff", gridcolor="#1a2035", zerolinecolor="#3a4560"
            ),
            yaxis=dict(
                title="y", color="#5b7fff", gridcolor="#1a2035", zerolinecolor="#3a4560"
            ),
            zaxis=dict(
                title="z", color="#5b7fff", gridcolor="#1a2035", zerolinecolor="#3a4560"
            ),
